...
genai.configure(api_key="AIzaSyBy4o3mm2QvpUs7J8SeiInRVBygeABZC0w")  # Replace with your actual API key
...
def get_completion_from_messages(messages, model="gemini-2.0-flash", temperature=0.7, max_tokens=500):
    genai.configure(api_key="AIzaSyBy4o3mm2QvpUs7J8SeiInRVBygeABZC0w")  # Replace with your actual API key
